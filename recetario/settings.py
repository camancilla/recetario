...
#Aqui es donde se encuentran algunas de las caracteristicas del proyecto
#en cuanto a la base de datos, administrador del proyecto, zona horaria, y otras que aun no comprendo :P ...
...
ADMINS = (
    ('Carlos Alberto Mancilla Castillo', 'carlosmllcll@hotmail.com'),
)
...
SECRET_KEY = '&1nnbylfcb-m3au()(&j---y1sw$-t$amgjw3)%+-#u6-9lq29'
