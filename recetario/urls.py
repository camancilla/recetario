...
#Aqui se agregan todas las vistas creadas en views.py con el nombre del archivo (.html) y el nombre de la vista que le corresponde


urlpatterns = patterns('',
	url(r'^$','principal.views.inicio'),
	#por ejemplo 'usuarios' es el archivo html que se mostrara de acuerso a la vista 'principal.views.usuarios'
